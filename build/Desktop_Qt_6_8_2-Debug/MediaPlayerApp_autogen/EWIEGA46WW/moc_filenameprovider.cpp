...
static constexpr auto qt_meta_stringdata_ZN16FileNameProviderE = QtMocHelpers::stringData(
    "FileNameProvider",
    "getFileName",
    "",
    "p"
...
Q_CONSTINIT static const uint qt_meta_data_ZN16FileNameProviderE[] = {
...
Q_CONSTINIT const QMetaObject FileNameProvider::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16FileNameProviderE.offsetsAndSizes,
    qt_meta_data_ZN16FileNameProviderE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16FileNameProviderE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<FileNameProvider, std::true_type>,
        // method 'getFileName'
...
void *FileNameProvider::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16FileNameProviderE.stringdata0))
